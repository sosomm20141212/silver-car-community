jQuery("#simulation")
  .on("mouseenter dragenter", ".s-d12245cc-1680-458d-89dd-4f0d7fb22724 .mouseenter", function(event, data) {
    ...
    if(jFirer.is("#s-Button_43") && jFirer.has(event.relatedTarget).length === 0) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-d12245cc-1680-458d-89dd-4f0d7fb22724 #s-Button_43 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-d12245cc-1680-458d-89dd-4f0d7fb22724 #s-Button_42 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
                      "background-color": "#3E3E3E"
                    }
                  } ],
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-d12245cc-1680-458d-89dd-4f0d7fb22724 #s-Button_41 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
                      "background-color": "#3E3E3E"
                    }
                  } ],

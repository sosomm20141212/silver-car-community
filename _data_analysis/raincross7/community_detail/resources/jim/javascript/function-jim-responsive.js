  ...
  var jimResponsive = {
	...
	"resetOriginalTableSize" : function($table, resetWidth, resetHeight, cellSizeMap, newTableWidth, newTableHeight){
	  ...
	  "refreshResponsiveRelativeItem" : function(item) {
		...
		relativeWrapper.children().css("width", (parentBounds.width - 2) + "px"); // minus for scroll bar workaroud
		relativeWrapper.children().css("height", (parentBounds.height - 2) + "px"); // minus for scroll bar workaroud
	  },
